        ...
        <div class="my-container container mt-5 text-center p-5">
            ...
            <form action="index.php" method="GET" class="row align-items-center">
                <div class="col-6 offset-3 row">
                    ...
                    <input class="col-8" type="number" name="passwordLength" id="passwordLength" placeholder="Scegli la lunghezza della password" max="40" min="1" value="<?php echo isset($_GET['passwordLength']) ? $_GET['passwordLength'] : '' ?>">
                </div>
